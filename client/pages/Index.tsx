        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={stagger}>
            ...
            <motion.div variants={stagger} initial="hidden" whileInView="visible" viewport={{ once: true }}
              ...
              {[
                { icon: "📧", label: "Email",     value: "sahilpixelpulse@gmail.com", href: "mailto:sahilpixelpulse@gmail.com" },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-10 mb-10">
            ...
            <div>
              ...
              <ul className="space-y-2.5 text-sm text-white/50">
                <li><a href="mailto:sahilpixelpulse@gmail.com" className="hover:text-white transition-colors">📧 sahilpixelpulse@gmail.com</a></li>
